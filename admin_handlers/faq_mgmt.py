...
ADD_Q, ADD_A, EDIT_Q, EDIT_A = range(4)
...
async def faq_edit_receive_a(
    ...
    await db.update_faq(fid, question=str(new_q), answer=str(new_a or ""))
...
def register(app) -> None:
    conv = ConversationHandler(
        ...
        states={
            ...
            ADD_A: [
                MessageHandler(
                    filters.TEXT & ~filters.COMMAND, faq_add_receive_a
                )
            ],
            EDIT_Q: [
                MessageHandler(
                    filters.TEXT & ~filters.COMMAND, faq_edit_receive_q
                )
            ],
            EDIT_A: [
                MessageHandler(
                    filters.TEXT & ~filters.COMMAND, faq_edit_receive_a
                )
            ],
        },
